...
import GatePasses from "../../screens/app/admin/GatePasses";
import ViewGatePass from "../../screens/app/admin/gate_passes/ViewGatePass";
...
export const AdminDashboard = () => {
   return (
      ...
      >
         ...
         />
         <DashboardStack.Screen
            name="AdminGatePassesDashboard"
            component={AdminGatePasses}
         />
         <DashboardStack.Screen
...
export const AdminGatePasses = () => {
   return (
      <GatePassesStack.Navigator
         initialRouteName="AdminGatePasses"
         screenOptions={{
            headerShown: false,
         }}
      >
         <GatePassesStack.Screen
            name="AdminGatePasses"
            component={GatePasses}
         />
         <GatePassesStack.Screen
            name="AdminViewGatePass"
